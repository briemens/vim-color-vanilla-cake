...
" Last Updated: Sat 13 Jul 2019 11:55:47 AM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#566b60', '#d4576a', '#358961', '#d08800',
        \ '#5674a5', '#c56591', '#428374', '#f9ebd0', '#566b60', '#d4576a',
        \ '#358961', '#d08800', '#5674a5', '#c56591', '#428374', '#f9ebd0']
  ...
  hi Label guifg=#c56591 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#c56591 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreCondit guifg=#c56591 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Exception guifg=#c56591 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Conditional guifg=#d4576a guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi PreCondit ctermfg=168 ctermbg=NONE cterm=NONE
